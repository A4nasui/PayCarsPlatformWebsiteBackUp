...
include '../public/database/koneksi.php';
...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="#" target="_blank">
        ...
        <span class="ms-1 font-weight-bold">Payment Cars</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="../pages/payment.html">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="../pages/showroom.html">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="../pages/cars.html">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <div class="container-fluid py-1 px-3">
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <ul class="navbar-nav  justify-content-end">
            ...
            <li class="nav-item d-flex align-items-center btn-group dropdown">
              <a href="javascript:;" class="nav-link text-body font-weight-bold px-0" data-bs-toggle="dropdown" aria-expanded="false">
              ...
              <ul class="dropdown-menu dropdown-menu-end px-4 py-4 me-sm-n3" aria-labelledby="dropdownMenuButton">
                <li class="mb-3">
                  <a href="../pages/profile.html">
                    <div class="d-flex" style="width: 250px;">
                      <div class="my-auto">
                        <img src="../assets/img/team/profile-1.png" class="avatar avatar-sm  me-3 ">
                      </div>
                      <div class="d-flex flex-column justify-content-center">
                        <h6 class="text-sm font-weight-normal mb-1">
                          <span class="font-weight-bold">KiRaRyuuKi</span>
                        </h6>
                        <p class="text-xs text-secondary mb-0">
                          <i class="fa fa-clock me-1"></i>
                          13 minutes ago
                ...
                <li class="mb-0">
                  <button type="button" class="btn bg-gradient-danger col-12 mb-0 mt-2        align-items-center">
                    Sign Out
                  </button>
                </li>
              </ul>
            ...
            <div class="card-header pb-0">
              <div class="row">
                ...
                <div class="col-6 text-end">
                  ...
                  <button type="button" class="btn bg-gradient-warning col-3 mb-0" data-bs-toggle="modal" data-bs-target="#modalAdd">
                    Add <i class="ni ni-fat-add"></i>
                  </button>
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body text-start">
                            <div class="card card-plain">
                              <div class="author align-items-center mb-3">
                                <img src="../assets/img/team/profile-1.png" alt="..." id="avatar" class="avatar shadow" style="width: 100px; height: 100px; object-fit: cover;">
                                <div class="name ps-3">
                                  <div class="row">
                                    <h6 class="mb-0">Profile Photo</h6>
                                    <div class="col">
                                      <button type="button" class="btn bg-gradient-secondary mt-2 mb-2" onclick="openFilePicker()">
                                        Add Picture
                                        <input type="file" id="upload" class="file-input" hidden style="display: none;" accept="image/png, image/jpeg" onchange="displaySelectedImage()" />
                                      </button>
                                      <button type="button" class="btn bg-gradient-default mt-2 ms-1 mb-2" onclick="resetImage()">
                                        Reset
                                      </button>
                                    </div>
                              ...
                              <form role="form text-left">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col">
                                    <label class="mb-0">Id Pengguna</label>
                                    <div class="col input-group mb-1">
                                      <input type="text" class="form-control" placeholder="Enter Your Id" aria-label="Id" aria-describedby="id-addon">
                                    </div>
                                  </div>
                                ...
                                <div class="row">
                                  ...
                                  <div class="col">
                                    ...
                                    <div class="col input-group mb-1">
                                      <input type="text" class="form-control" placeholder="Enter Your Username" aria-label="Username" aria-describedby="username-addon">
                                    </div>
                                  </div>
                                ...
                                <div class="row">
                                  ...
                                  <div class="col">
                                    <label class="mb-0">No Telephone</label>
                                    <div class="col input-group mb-1">
                                      <input type="text" class="form-control" placeholder="Enter No Telephone" aria-label="Telephone" aria-describedby="telephone-addon">
                                    </div>
                                  </div>
                          ...
                          <div class="modal-footer">
                            ...
                            <button type="submit" name="button" data-bs-toggle="modal" data-bs-target="#modalAdd" class="btn bg-gradient-warning">Add Account</button>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <table class="table align-items-center mb-0">
                  ...
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">No Telephone
                      </th>
                      ...
                      <tr>
                        <td>
                          <div class="d-flex px-2 py-1">
                            <div>
                              <img src="../assets/img/team/profile-1.png" class="avatar avatar-sm me-3" alt="user1">
                            </div>
                            <div class="d-flex flex-column justify-content-center">
                              <h6 class="mb-0 text-sm"><?= $data["username_pengguna"] ?></h6>
                              <p class="text-xs text-secondary mb-0"><?= $data["email_pengguna"] ?></p>
                            </div>
                          </div>
                        </td>
                        <td>
                          <p class="text-xs font-weight-bold mb-0"><?= $data["nama_pengguna"] ?></p>
                        </td>
                        <td class="align-middle text-center text-sm">
                          <span class="text-xs font-weight-bold mb-0"><?= $data["tipe_akun"] ?></span>
                          <p class="text-xs text-secondary mb-0"><?= $data["status_pengguna"] ?></p>
                        </td>
                        <td class="align-middle text-center">
                          <span class="text-secondary text-xs font-weight-bold"><?= $data["nomor_telepon_pengguna"] ?></span>
                        </td>
                        ...
                        <td class="align-middle text-center">
                          ...
                          <a href="edit_pengguna.php?id_pengguna=<?= $data["id_pengguna"] ?>" class="text-secondary font-weight-bold text-xs px-2" data-toggle="tooltip" data-original-title="Edit user" data-bs-toggle="modal" data-bs-target="#EditModalMessage">
                            Edit
                          </a>

                          <!-- Modal Edit -->
                          <div class="modal fade" id="EditModalMessage" tabindex="-1" role="dialog" aria-labelledby="exampleModalMessageTitle" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                              <div class="modal-content">
                                <div class="modal-header">
                                  ...
                                  <form method="post">
                                    <div class="row">
                                      <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" value="Masukkan Id Pengguna" id="recipient-name">
                                      </div>

                                      <div class="col-md-6">
                                        <label for="recipient-name" class="col-form-label">Nama:</label>
                                        <input type="text" class="form-control" value="Masukkan Nama" id="recipient-name">
                                      </div>
                                    </div>
                                    ...
                                    <div class="row">
                                      <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" value="Masukkan Username" id="recipient-name">
                                      </div>

                                      <div class="col-md-6">
                                        <label for="recipient-name" class="col-form-label">Email:</label>
                                        <input type="email" class="form-control" value="Masukkan Email" id="recipient-name">
                                      </div>
                                    </div>
                                    ...
                                    <div class="row">
                                      <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" value="Masukkan Password" id="recipient-name">
                                      </div>

                                      <div class="col-md-6">
                                        <label for="recipient-name" class="col-form-label">No Telepon:</label>
                                        <input type="number" class="form-control" value="Masukkan No Telepon" id="recipient-name">
                                      </div>
                                    </div>
                                    ...
                                    <div class="row">
                                      <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" value="Masukkan Alamat" id="recipient-name">
                                      </div>

                                      <div class="col-md-6">
                                        <label for="recipient-name" class="col-form-label">Tipe Akun:</label>
                                        <input type="text" class="form-control" value="Masukkan Tipe Akun" id="recipient-name">
                                      </div>
                                    </div>

                                    <div class="row">
                                      <div class="col-md-6">
                                        <label for="recipient-name" class="col-form-label">Status Pengguna:</label>
                                        <input type="text" class="form-control" value="Masukkan Status" id="recipient-name">
                                      </div>

                                      <div class="col-md-6">
                                        <label for="recipient-name" class="col-form-label">Profil Pengguna:</label>
                                        <input type="text" class="form-control" value="Masukkan Profil" id="recipient-name">
                                      </div>
                                    </div>
                          ...
                          <a href="javascript:;" class="text-secondary font-weight-bold text-xs px-1" data-toggle="tooltip" data-original-title="Edit user" data-bs-toggle="modal" data-bs-target="#HapusModalMessage">
                            Hapus
                          </a>

                          <!-- Modal Hapus -->
                          <div class="modal fade" id="HapusModalMessage" tabindex="-1" role="dialog" aria-labelledby="exampleModalMessageTitle" aria-hidden="true">
                        ...
                        <!-- <td class="align-middle text-center">
                          ...
                          <a href="javascript:;" class="text-secondary font-weight-bold text-xs px-3" data-toggle="tooltip" data-original-title="Delete user">
                            Delete
                          </a>
                        </td> -->
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-6 mb-lg-0 mb-4">
              <div class="copyright text-center text-sm text-muted text-lg-start">
                ...
                made with </i> by
                <a href="#" class="font-weight-bold" target="_blank">ORKESTRA</a>
                (PayCars : Payment Cars)
              </div>
            </div>
            <div class="col-lg-6">
              <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                <li class="nav-item">
                  <a href="#" class="nav-link text-muted" target="_blank">ORKESTRA</a>
                </li>
                <li class="nav-item">
  ...
  <script>
    ...
    function displaySelectedImage() {
      ...
      var selectedImage = document.getElementById('avatar');
      ...
      if (fileInput.files && fileInput.files.length > 0) {
        ...
        if (fileSizeKB > maxSizeKB) {
          alert('File size exceeds the maximum allowed size of 800KB.');
          fileInput.value = '';
        } else {
    ...
    function resetImage() {
      var defaultImagePath = "../assets/img/team/profile-1.png";
      document.getElementById('avatar').src = defaultImagePath;
    }
  </script>
  <!-- Github buttons -->
